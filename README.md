...
<h5> !! Comf. Characters !! >> Ghostface,Ferryman/Gabriel(UK),Harry(MBV),Player (PPT),  Crowe (TKATB),Wesker (RE),Deadpool,Horangi (COD),Honglu (LC),Itha / Jos / Frede (IDV),Elliot,Malleus, Jason Todd,Fool (Grace),Wemmbu,Eggchan </h5>
